          ...
          <div className="flex-col justify-center mx-auto px-4 py-20 relative z-20 h-full flex items-center">
            <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
              ...
              <div className="text-white mt-16 md:mt-0">
                ...
                Expressing Literature Through Artistic Vision
                </h2>
                <p className="text-sm max-w-6xl  text-center text-gray-600 md:text-lg mb-8">
                Book illustration is the creative blend of words and imagery, enhancing the storytelling experience for readers of all ages. Visuals That Speak Volumes.
                </p>
              </div>
            </div>
          </div>
