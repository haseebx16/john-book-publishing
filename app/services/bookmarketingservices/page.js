          ...
          <div className="flex-col justify-center mx-auto px-4 py-20 relative z-20 h-full flex items-center">
            <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
              ...
              <div className="text-white mt-16 md:mt-0">
                ...
                Excelling in book marketing involves executing strategic approaches to boost visibility, spark interest, and build meaningful connections with your target audience. Effective book marketing is all about employing deliberate tactics to increase awareness, engage readers, and establish strong relationships with those who are most likely to appreciate your work.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                ...
                Tailored Strategies for Your Unique Marketing Goals
                </h2>
                ...
                <h2 className="text-4xl font-oswald text-gray-800 mb-6">
                Our Author-Focused Marketing Philosophy
                </h2>
                <p className="text-gray-700 leading-relaxed">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="lg:w-3/4">
                ...
                Where language comes alive, crafting a captivating tapestry of imagination.
                </h2>
              </div>
